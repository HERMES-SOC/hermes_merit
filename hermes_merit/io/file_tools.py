...
def parse_l0_sci_packets(data_filename: Path) -> HermesData:
    ...
    >>> data_filename = "hermes_MERIT_l0_2022239-000000_v0.bin"
    ...
    try:
        ...
        raise RuntimeError(
            f"Failed to Parse Packets for file:{data_filename}. Please ensure Packet Definition: MERIT_sci_packet_def.csv is correct."
        )
